...
(function (global, factory) {
    ...
    class GeoChoroplethChart extends ColorMixin(BaseMixin) {
         ...
         * {@link https://github.com/d3/d3-geo/blob/master/README.md#geoMercator d3.geoMercator()}. Please
         ...
         * @param {d3.projection} [projection=d3.geoMercator()]
        ...
        _getGeoPath () {
            if (this._projection === undefined) {
                ...
                return this._geoPath.projection(d3Geo.geoMercator());
            }
